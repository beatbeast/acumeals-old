...
function validate()
{
	...
	{
		alert("Enter the valid Mobile Number(Like : 08000000000)");
		mob.focus();
		return false;
	}
...
<OPTION VALUE="none" disabled selected>-------SELECT YOUR HOSTEL-------</OPTION>
<OPTION VALUE="ibadan" style="color:black;">PETER JASPER AKINOLA HALL(IBADAN) </OPTION>
<OPTION VALUE="lagos" style="color:black;">LAGOS HOSTEL</OPTION>
<OPTION VALUE="dlw" style="color:black;">DIOCESE OF LAGOS WEST HOSTEL(DLW)</OPTION>
<OPTION VALUE="colombia" style="color:black;">JAH HOSTEL(COLOMBIA)</OPTION>
<OPTION VALUE="ufh" style="color:black;">UNIVERSITY FEMALE HOSTEL(UFH)</OPTION>
</SELECT></TD>
</TR>
<TR class="left">
<TD><FONT size="5" color="WHITE">Mobile Number:</FONT></TD>
<TD><INPUT type="TEXT" name="mob" size="30" maxlength="11" placeholder="Enter your mobile number" id="mob"></TD>
</TR>
<TR class="left">
<TD><FONT size="5" color="WHITE">Room Number:</FONT></TD>
<TD class="left"><TEXTAREA rows="7" cols="33" wrap="physical" placeholder="Enter your room number" id="addr" name="addr"></TEXTAREA></TD>
</TR>
<TR class="left">
...
<a href="clogin.html"><INPUT TYPE="login" value="Login" id="login" class="button"></a>
</P>
</FORM>
</BODY>
</HTML>
